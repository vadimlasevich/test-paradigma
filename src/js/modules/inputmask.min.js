        ...
        function (module, exports, __webpack_require__) {
          ...
          (Inputmask.prototype = {
            ...
            defaults: {
              ...
              ignorables: [
                8, 9, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122,
                123, 0, 229,
              ],
              isComplete: null,
              preValidation: null,
              ...
              function resolveNamespace(ev, namespace) {
                ...
                if (0 < ev.length)
                  if (void 0 === handler)
                    ...
                    evts.push({ ev: ev, namespace: namespace && 0 < namespace.length ? namespace : 'global', handler: handler });
            ...
            function revalidateMask(pos, validTest, fromIsValid, validatedPos) {
              ...
              if (
                ...
                for (
                  i = j,
                    validTest &&
                      ((maskset.validPositions[validatedPos] = $.extend(!0, {}, validTest)), posMatch++, j++, begin < end && i++);
                  i <= lvp;
                  i++
                ) {
                  if (
            ...
            var EventRuler = {
              ...
              EventHandlers = {
                ...
                keypressEvent: function keypressEvent(e, checkval, writeOut, strict, ndx) {
                  ...
                  if (k) {
                    ...
                    if (
                      ...
                      (forwardPosition =
                        opts.numericInput && void 0 === valResult.caret ? seekPrevious(forwardPosition) : forwardPosition),
                      !1 !== writeOut &&
                        (setTimeout(function () {
                ...
                pasteEvent: function pasteEvent(e) {
                  ...
                  if (
                    (valueBeforeCaret ==
                      (isRTL ? getBufferTemplate().slice().reverse() : getBufferTemplate()).slice(0, caretPos.begin).join('') &&
                      (valueBeforeCaret = ''),
                    valueAfterCaret ==
                      (isRTL ? getBufferTemplate().slice().reverse() : getBufferTemplate()).slice(caretPos.end).join('') &&
                      (valueAfterCaret = ''),
